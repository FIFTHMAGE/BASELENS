      ...
      <div className="glass-card">
        ...
        {!walletConnected ? (
          <div className="p-6 text-center">
            ...
            <p className="text-gray-300 mb-6 text-sm">Connect your Farcaster wallet to manage subscriptions and make USDC payments</p>
            <button 
          ...
          <div className="p-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              ...
              <div className="text-right">
                <p className="text-white font-medium text-sm">USDC Balance</p>
                <p className="text-green-400 text-xl font-bold">{usdcBalance.toLocaleString()}</p>
              </div>
            </div>
            ...
            {addons.map((addon, index) => {
              ...
              return (
                <div key={index} className="glass-card p-4">
                  <h3 className="text-base font-semibold text-white mb-2">{addon.name}</h3>
                  <p className="text-gray-300 text-xs mb-3">{addon.description}</p>
                  ...
                  <button 
                    ...
                    disabled={!walletConnected || !canAfford}
                    className={`btn-secondary w-full text-sm py-2 ${!walletConnected || !canAfford ? 'opacity-50 cursor-not-allowed' : ''}`}
                  >
                    {!walletConnected ? 'Connect Wallet First' : 
        ...
        <div className="p-6">
          <div className="space-y-4">
            <div className="border-b border-white/10 pb-4">
              <h3 className="text-base font-semibold text-white mb-2">How do USDC payments work?</h3>
      ...
      <div className="glass-card text-center">
        <div className="p-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button className="btn-secondary text-lg px-6 py-3">Schedule Demo</button>
          </div>
        </div>
      </div>
    </div>
